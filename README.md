...
MuJoCo reinforcement-learning baselines for robot control tasks using Gymnasium and Stable-Baselines3.
...
python scripts/evaluate.py \
  --algo ppo \
  --env Reacher-v5 \
  --model checkpoints/Reacher-v5_ppo_seed0/final_model.zip \
  --episodes 10 \
  --output results/Reacher-v5_ppo_seed0_eval.csv
```

## Plot

```bash
python scripts/plot_returns.py results/Reacher-v5_ppo_seed0_returns.csv
